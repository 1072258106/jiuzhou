...
public final class ViewfinderView extends View
{
    ...
    public void onDraw(Canvas canvas)
    {
        ...
        else
        {
            ...
            canvas.drawRect(frame.left /*+ CORNER_WIDTH*/, /*slideTop*/ frame.top+(frame.bottom-frame.top)/2  , frame.right
                    /*- CORNER_WIDTH*/, /*slideTop +*/ frame.top+(frame.bottom-frame.top)/2+MIDDLE_LINE_WIDTH-2, paint);
            ...
            float strwid = paint.measureText(getResources().getString(R.string.msg_default_status));
            
            canvas.drawText(
                    getResources().getString(R.string.msg_default_status),
                    frame.left + ((frame.right - frame.left)-strwid)/2 , frame.bottom + TEXT_PADDING_TOP * density,
                    paint);

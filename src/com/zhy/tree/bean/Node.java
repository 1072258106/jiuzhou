...
//	private int level;
	...
	public Node(int id, int pId, String name,boolean isChild,List<DeptModel> submodel,List<UserInfoModel> info)
	{
		super();
		this.id = id;
		this.pId = pId;
	...
	public Node(int id, int pId, String name,boolean isChild,List<CategoryModel> subCategory)
	{
		super();
		this.id = id;
		this.pId = pId;

...
public class UpdateManager
{
	...
	public UpdateManager(Context context,String mDownUrl)
	{
		...
		public void run()
		{
			try
			{
				...
				if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED))
				{
					...
					String apk = "http://gdown.baidu.com/data/wisegame/f98d235e39e29031/baiduxinwen.apk";
					...
					File apkFile = new File(mSavePath, "eam.apk");
